...
```bash
SCHEDULE_ROTA_GROUP_REMINDER=0 9 * * MON       # Monday 9 AM
SCHEDULE_ROTA_DM_FRIDAY=0 17 * * FRI           # Friday 5 PM
SCHEDULE_ROTA_DM_MONDAY=0 9 * * MON            # Monday 9 AM
SCHEDULE_ROTA_SHEET_SYNC=0 8 * * *             # Every day 8 AM
```

### Job Control

```bash
# Jobs are enabled by setting their schedule (non-empty cron expression)
# Jobs are disabled by setting schedule to empty string

SCHEDULE_ROTA_GROUP_REMINDER=0 9 * * MON,THU   # Enabled
SCHEDULE_ROTA_DM_FRIDAY=0 17 * * FRI           # Enabled
SCHEDULE_ROTA_DM_MONDAY=0 9 * * MON            # Enabled
SCHEDULE_ROTA_SHEET_SYNC=0 8 * * *             # Enabled

# To disable a job, use empty string:
SCHEDULE_ROTA_GROUP_REMINDER=                  # Disabled
```
