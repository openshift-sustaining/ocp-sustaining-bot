...
def test_handle_aws_modify_vm_stop_success(mock_ec2_helper):
    ...
    handle_aws_modify_vm(
        ...
        region="us-east-1",
        user="test-user",
        command_line="aws-modify-vm --stop --vm-id=i-1234567890",
    )
...
def test_handle_aws_modify_vm_delete_success(mock_ec2_helper):
    ...
    handle_aws_modify_vm(
        ...
        region="us-east-1",
        user="test-user",
        command_line="aws-modify-vm --delete --vm-id=i-1234567890",
    )
...
def test_handle_aws_modify_vm_missing_vm_id(mock_ec2_helper):
    ...
    handle_aws_modify_vm(
        ...
        region="us-east-1",
        user="test-user",
        command_line="aws-modify-vm --stop",
    )
...
def test_handle_aws_modify_vm_missing_action(mock_ec2_helper):
    ...
    handle_aws_modify_vm(
        ...
        region="us-east-1",
        user="test-user",
        command_line="aws-modify-vm --vm-id=i-1234567890",
    )
...
def test_handle_aws_modify_vm_both_actions(mock_ec2_helper):
    ...
    handle_aws_modify_vm(
        ...
        region="us-east-1",
        user="test-user",
        command_line="aws-modify-vm --stop --delete --vm-id=i-1234567890",
    )
...
def test_handle_aws_modify_vm_stop_failure(mock_ec2_helper):
    ...
    assert "already stopped" in calls[1][0][0]
